package mx.habil.dummy.dropwizard.exception;

public class ServicioRestDummyException extends RuntimeException{
     ...
     * Constructor
     */
    public ServicioRestDummyException() {
    }
     ...
     */
    public ServicioRestDummyException(String msg) {
        super(msg);
    }
     ...
     */
    public ServicioRestDummyException(Throwable cause) {
        super();
        this.cause = cause;
    }
     ...
     * @param cause the nested exception (caused by)
     */
    public ServicioRestDummyException(String msg, Throwable cause) {
        super(msg);
        this.cause = cause;
    }
